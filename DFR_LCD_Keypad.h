...
//Support for variant LCD Keypad Shield board
#undef DFR_LCD_KEYPAD_KEY_UP_ADC_LOW
#define DFR_LCD_KEYPAD_KEY_UP_ADC_LOW      90
#undef DFR_LCD_KEYPAD_KEY_DOWN_ADC_LOW
#define DFR_LCD_KEYPAD_KEY_DOWN_ADC_LOW    240
#undef DFR_LCD_KEYPAD_KEY_LEFT_ADC_LOW
#define DFR_LCD_KEYPAD_KEY_LEFT_ADC_LOW    390
#undef DFR_LCD_KEYPAD_KEY_SELECT_ADC_LOW
#define DFR_LCD_KEYPAD_KEY_SELECT_ADC_LOW  630
